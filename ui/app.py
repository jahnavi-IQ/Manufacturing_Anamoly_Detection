...
def show_analysis_results(result, uploaded_file, start_time):
    """Display metrics, tabs, and downloads."""
...
def main():
    ...
    if uploaded_file is not None:
        ...
        st.session_state.just_ran_analyze = False
        ...
        if st.button("Analyze Pump Audio", type="primary", width='stretch'):
            with st.spinner("Analyzing audio... This may take a few seconds..."):
                ...
                if result:
                    ...
                    show_analysis_results(result, uploaded_file, start_time)
                    st.session_state.just_ran_analyze = True
        ...
        if (
            ...
            and not st.session_state.get("just_ran_analyze", False)
        ):
